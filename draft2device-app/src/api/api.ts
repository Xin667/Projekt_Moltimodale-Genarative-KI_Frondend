...
/** POST /code/{project_id}/answers — speichert die Konfiguration und regeneriert den Code. */
export async function submitCodeAnswers(
  projectId: string,
  ...
  return data as GeneratedCodeResult
}
